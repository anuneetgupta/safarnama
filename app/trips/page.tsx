...
export default function TripsPage() {
    ...
    return (
        <main className="min-h-screen" style={{ background: '#0d150b' }}>
                ...
                <div className="container-main relative z-10">
                    <div className="max-w-[640px]">
                        ...
                        >
                            ...
                            <p className="text-[17px] leading-[1.75] mb-10 max-w-[500px]" style={{ color: 'rgba(180,200,140,0.6)' }}>
                            ...
                            <div className="flex flex-wrap gap-3">
                                {[
                                    ...
                                    <div key={b.text} className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-lime-400/5 border border-lime-400/10 text-[13px] text-slate-300 font-medium">
            ...
            {/* ── STICKY FILTER BAR ── */}
            <div className="sticky top-[80px] z-30 backdrop-blur-2xl border-y border-lime-400/10" style={{ background: 'rgba(13,21,11,0.95)' }}>
                <div className="container-main">
                    <div className="flex items-center justify-between gap-4 py-4">
                                ...
                                <button
                                    ...
                                    className={`flex items-center gap-2 px-4 py-2 rounded-lg text-[13px] font-semibold transition-all duration-200 ${
                                        activeFilter === f.value
                                            ...
                                            : 'hover:text-white hover:bg-white/[0.06] border border-lime-400/10'
                                    }`}
                                    style={activeFilter !== f.value ? { color: 'rgba(180,200,140,0.6)' } : undefined}
                                >
                                    <span>{f.icon}</span>
                                    {f.label}
                                </button>
                        ...
                        <select
                            ...
                            className="text-[13px] text-slate-300 border border-lime-400/10 rounded-lg px-4 py-2 outline-none cursor-pointer hover:border-lime-400/30 transition-colors min-w-[170px]"
                            style={{ background: '#0a1208' }}
                        >
                            {SORT_OPTIONS.map((o) => (
                                <option key={o} value={o} style={{ background: '#0a1208' }}>{o}</option>
                            ))}
                        </select>
                    </div>
                </div>
            ...
            <section className="container-main py-16">
                <div className="flex items-center justify-between mb-10">
                    <div>
                        ...
                        <p className="text-sm mt-1" style={{ color: 'rgba(180,200,140,0.4)' }}>
                    ...
                    {activeFilter !== 'All' && (
                        <button
                            ...
                            className="flex items-center gap-2 text-[13px] border border-lime-400/10 hover:border-lime-400/30 px-3 py-2 rounded-lg transition-all hover:text-lime-300"
                            style={{ color: 'rgba(180,200,140,0.4)' }}
                        >
                ...
                {filteredTrips.length > 0 && (
                    <motion.div
                        ...
                        viewport={{ once: true }}
                    >
                        <div className="absolute inset-0 bg-gradient-to-br from-lime-600/20 via-[#111a0f] to-amber-600/15" />
                        <div className="absolute inset-0 border border-lime-400/10 rounded-3xl" />
                        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[500px] h-[200px] bg-lime-500/10 rounded-full blur-[80px]" />

                        <div className="relative z-10 px-10 py-16 md:px-20 flex flex-col md:flex-row items-center justify-between gap-8">
                            <div>
                                <p className="text-lime-400 text-[11px] font-bold uppercase tracking-[0.15em] mb-3">Custom Trips</p>
                                ...
                                <p className="text-base leading-relaxed max-w-[380px]" style={{ color: 'rgba(180,200,140,0.6)' }}>
