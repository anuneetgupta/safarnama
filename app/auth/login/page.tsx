                    ...
                    <div className="lc-form">
                        ...
                        <form onSubmit={handleSubmit} noValidate>
                            ...
                            <div className="lc-social">
                                {/* Only Google is configured in auth.ts */}
                                <button
                                    type="button"
                                    className="lc-soc-btn"
                                    style={{ width: '100%', gap: '10px', fontSize: '14px', fontWeight: 600, color: 'rgba(226,232,240,0.8)', letterSpacing: '0.01em' }}
